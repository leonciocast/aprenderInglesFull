...
const BATHROOM_FILES = [
  'plunger--toothpaste-toothbrush.png',
  'shower--toothpaste-toothbrush.png',
  'sink-shower-towel.png',
  'soap-toothpaste-toothbrush.png',
  'toilet-toothpaste-toothbrush.png',
  'toilet_paper-Lavabo-shower.png',
  'toothbrush-toothpaste-toothbrush.png',
  'toothpaste-toothbrush-shower.png',
  'towel-toothpaste-toothbrush.png',
];
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        if (!meRes.ok) {
          router.replace(`/auth/login?next=${encodeURIComponent('/principiantes/bathroom')}`);
          return;
        }
        setAuthReady(true);
      } catch {
