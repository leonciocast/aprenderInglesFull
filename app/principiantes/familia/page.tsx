...
const FAMILY_FILES = [
  'Brother-pants-skirt.png',
  'Daughter-pants-skirt.png',
  'Family-pants-skirt.png',
  'Father-pants-skirt.png',
  'Grandfather-pants-skirt.png',
  'Grandmother-pants-skirt.png',
  'Mother-pants-skirt.png',
  'Sister-pants-skirt.png',
  'Son-pants-skirt.png',
];

const FAMILY_STOPWORDS = ['pants', 'skirt'];
const IMAGE_BASE = '/uploader/image/Family';
const AUDIO_BASE = '/uploader/Audio/Family';
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        if (!meRes.ok) {
          router.replace(`/auth/login?next=${encodeURIComponent('/principiantes/familia')}`);
          return;
        }
        setAuthReady(true);
      } catch {
      ...
      <div className="student-layout">
        ...
        <div className="student-content">
          <section className="quiz-header">
            <div>
              <h1>Familia</h1>
              <p className="ui-muted">Selecciona el familiar correcto en cada tarjeta.</p>
            </div>
            <button
              type="button"
              className="ui-button"
